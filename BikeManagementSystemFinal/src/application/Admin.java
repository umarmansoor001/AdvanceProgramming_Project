...
public class Admin 
{
	...
	public boolean ChangeDetails(int Id) throws ClassNotFoundException, SQLException 
	{
			ResultSet rs = null;
	...
	public boolean DeleteDetails(int Employee_Id) throws ClassNotFoundException, SQLException {
